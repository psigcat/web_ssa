...
<html>
	...
	<body>
        ...
        <div id="angularAppContainer" ng-app="app" ng-controller="mainController as mc" ng-init="initApp('<?php echo $baseHref; ?>','<?php echo $urlWMS; ?>','<?php echo $urlWMSqgis; ?>','<?php echo $env; ?>','<?php echo $token; ?>','<?php echo $isMobile; ?>')">
            ...
            <div class="window main">
                <div class="content">
                    <ul id="menu" class="list-unstyled list-inline">
                        <li><a href="<?php echo $baseHref?>home.php"><img src="tpl/default/img/logo.png" class="hidden-xs" /><img src="tpl/default/img/dbwater/logo-xs.jpg" class="visible-xs" /></a></li>
            ...
            <div class="window left-side search">
                ...
                <div class="content">
                    ...
                    <p>
                        <label for="searchParcela">Parcela</label>
    	...
    	<script src="js/app/mapService_sinmapproxy.js"></script>
